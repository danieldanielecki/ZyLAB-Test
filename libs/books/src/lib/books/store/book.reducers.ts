...
const initialState: State = {
  books: [
    new Book(1, 1969, "giovanni's room", 1, 'Ablex Publishing'),
    new Book(2, 1913, 'desert solitaire', 2, 'Berkley Books'),
    new Book(3, 1942, 'geek love', 2, 'Constable & Co Ltd'),
    new Book(4, 1955, 'lolita', 3, 'Crocker & Brewster'),
    new Book(
      5,
      2007,
    ...
    new Book(7, 2013, 'infinite jest', 1, "O'Reilly Media")
  ]
};
